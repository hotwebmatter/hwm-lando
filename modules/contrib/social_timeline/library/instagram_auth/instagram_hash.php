...
$media = $instagram->getTagMedia(urlencode($tag), $count);
$count = 0;
$json_format = '{"responseData": {"feed":{"feedUrl": "http://'.$_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"].'","title":"Instagram","link":"","author":"","description":"Instagram updates","type":"rss20","entries":[';
